...
**Tunables** : `ROCKET_SPEED_TILES_PER_SEC`, `ROCKET_TRAVEL_T_MIN/MAX`, `ROCKET_MISS_TRAVEL_T_MAX`, `ROCKET_AOE_TILES`, `ROCKET_AOE_Y_PX`, `ROCKET_RECOVERY_T`, `ROCKET_TOSS_DMG_MIN/MAX`, `TOSS_LAND_FRAME`, `TOSS_HEIGHT_MIN/MAX`, `RECOVERY_WAIT_IDLE_T` (combat-sim.js).
...
AIM_DELAY_MIN = 0.62       // durée minimale de montée en visée
AIM_HOLD = 0.24            // pause de tenue avant le premier tir
