...
(function () {
  ...
  const MANIFEST = [
    { name: 'SMG-01',     type: 'smg',     sx:  45, sy:  19, sw:  32, sh: 20, gripX:  9, gripY: 13, foregripX: 17, foregripY: 13, muzzleX: 31, muzzleY:  3 },
    { name: 'SMG-02',     type: 'smg',     sx:  45, sy:  53, sw:  24, sh: 22, gripX:  7, gripY: 15, foregripX: 15, foregripY: 10, muzzleX: 23, muzzleY:  4 },
    { name: 'SMG-03',     type: 'smg',     sx:  45, sy:  93, sw:  22, sh: 22, gripX:  8, gripY: 12, foregripX: 13, foregripY:  9, muzzleX: 21, muzzleY:  2 },
    { name: 'SMG-04',     type: 'smg',     sx:  45, sy: 138, sw:  27, sh: 31, gripX: 13, gripY: 13, foregripX: 15, foregripY: 13, muzzleX: 26, muzzleY:  6 },
    ...
    { name: 'RIFLE-01',   type: 'rifle',   sx: 352, sy:  19, sw:  46, sh: 16, gripX: 18, gripY: 11, foregripX: 29, foregripY: 11, muzzleX: 45, muzzleY:  3 },
    { name: 'RIFLE-02',   type: 'rifle',   sx: 352, sy:  44, sw:  42, sh: 15, gripX: 16, gripY: 10, foregripX: 29, foregripY: 10, muzzleX: 41, muzzleY:  2 },
    { name: 'RIFLE-03',   type: 'rifle',   sx: 352, sy:  68, sw:  49, sh: 15, gripX: 18, gripY: 10, foregripX: 36, foregripY: 10, muzzleX: 48, muzzleY:  4 },
    { name: 'RIFLE-04',   type: 'rifle',   sx: 352, sy:  92, sw:  65, sh: 16, gripX: 25, gripY: 11, foregripX: 39, foregripY: 10, muzzleX: 64, muzzleY:  5 },
    { name: 'RIFLE-05',   type: 'rifle',   sx: 352, sy: 117, sw:  61, sh: 15, gripX: 23, gripY: 10, foregripX: 38, foregripY: 10, muzzleX: 60, muzzleY:  4 },
    { name: 'RIFLE-06',   type: 'rifle',   sx: 352, sy: 140, sw:  64, sh: 16, gripX: 21, gripY: 11, foregripX: 43, foregripY: 10, muzzleX: 63, muzzleY:  5 },
    { name: 'RIFLE-07',   type: 'rifle',   sx: 352, sy: 166, sw:  54, sh: 15, gripX: 22, gripY: 10, foregripX: 38, foregripY: 10, muzzleX: 53, muzzleY:  4 },
    { name: 'RIFLE-08',   type: 'rifle',   sx: 352, sy: 190, sw:  67, sh: 15, gripX: 24, gripY: 10, foregripX: 42, foregripY: 10, muzzleX: 66, muzzleY:  4 },
    { name: 'RIFLE-09',   type: 'rifle',   sx: 352, sy: 214, sw:  43, sh: 16, gripX: 18, gripY: 11, foregripX: 29, foregripY: 11, muzzleX: 42, muzzleY:  5 },
    { name: 'RIFLE-10',   type: 'rifle',   sx: 352, sy: 239, sw:  37, sh: 16, gripX: 16, gripY: 11, foregripX: 25, foregripY: 11, muzzleX: 36, muzzleY:  5 },

    { name: 'HEAVY-01',   type: 'heavy',   sx: 700, sy:  24, sw:  56, sh: 22, gripX: 28, gripY: 16, foregripX: 39, foregripY: 15, muzzleX: 55, muzzleY: 10 },
    { name: 'HEAVY-02',   type: 'heavy',   sx: 700, sy:  59, sw:  62, sh: 16, gripX: 35, gripY: 13, foregripX: 48, foregripY: 12, muzzleX: 61, muzzleY:  7 },
    { name: 'HEAVY-03',   type: 'heavy',   sx: 700, sy:  87, sw:  63, sh: 20, gripX: 29, gripY: 15, foregripX: 43, foregripY: 15, muzzleX: 62, muzzleY:  7 },
    { name: 'HEAVY-04',   type: 'heavy',   sx: 700, sy: 120, sw:  56, sh: 18, gripX: 25, gripY: 13, foregripX: 40, foregripY: 12, muzzleX: 55, muzzleY:  6 },
    { name: 'HEAVY-05',   type: 'heavy',   sx: 700, sy: 151, sw:  55, sh: 17, gripX: 34, gripY: 13, foregripX: 44, foregripY: 13, muzzleX: 54, muzzleY:  7 },
    { name: 'HEAVY-06',   type: 'heavy',   sx: 700, sy: 180, sw:  62, sh: 15, gripX: 23, gripY: 12, foregripX: 43, foregripY: 11, muzzleX: 61, muzzleY:  6 },
    { name: 'HEAVY-07',   type: 'heavy',   sx: 700, sy: 208, sw:  60, sh: 15, gripX: 17, gripY: 12, foregripX: 37, foregripY: 10, muzzleX: 59, muzzleY:  5 },
    ...
    { name: 'SHOTGUN-01', type: 'shotgun', sx:  25, sy: 511, sw:  49, sh: 17, gripX: 13, gripY: 11, foregripX: 34, foregripY: 12, muzzleX: 48, muzzleY:  3 },
    { name: 'SHOTGUN-02', type: 'shotgun', sx:  23, sy: 546, sw:  63, sh: 16, gripX: 15, gripY: 12, foregripX: 40, foregripY: 11, muzzleX: 62, muzzleY:  2 },
    { name: 'SHOTGUN-03', type: 'shotgun', sx:  25, sy: 584, sw:  75, sh: 15, gripX: 21, gripY: 11, foregripX: 51, foregripY: 11, muzzleX: 74, muzzleY:  3 },
    { name: 'SHOTGUN-04', type: 'shotgun', sx:  25, sy: 625, sw:  56, sh: 16, gripX: 15, gripY: 11, foregripX: 36, foregripY: 11, muzzleX: 55, muzzleY:  2 },
    { name: 'SHOTGUN-05', type: 'shotgun', sx:  25, sy: 667, sw:  70, sh: 15, gripX: 22, gripY: 11, foregripX: 48, foregripY: 11, muzzleX: 69, muzzleY:  2 },
    { name: 'SHOTGUN-06', type: 'shotgun', sx:  25, sy: 708, sw:  69, sh: 16, gripX: 23, gripY: 10, foregripX: 50, foregripY: 10, muzzleX: 68, muzzleY:  3 },
    { name: 'SHOTGUN-07', type: 'shotgun', sx:  25, sy: 750, sw:  49, sh: 16, gripX: 16, gripY: 11, foregripX: 31, foregripY: 11, muzzleX: 48, muzzleY:  2 },
    { name: 'SHOTGUN-08', type: 'shotgun', sx:  25, sy: 792, sw:  74, sh: 16, gripX: 21, gripY: 10, foregripX: 51, foregripY: 11, muzzleX: 73, muzzleY:  4 },

    { name: 'SNIPER-01',  type: 'sniper',  sx: 352, sy: 500, sw: 112, sh: 24, gripX: 27, gripY: 17, foregripX: 60, foregripY: 15, muzzleX: 111, muzzleY: 11 },
    { name: 'SNIPER-02',  type: 'sniper',  sx: 352, sy: 539, sw: 106, sh: 20, gripX: 24, gripY: 15, foregripX: 57, foregripY: 13, muzzleX: 105, muzzleY:  7 },
    { name: 'SNIPER-03',  type: 'sniper',  sx: 352, sy: 574, sw:  96, sh: 23, gripX: 26, gripY: 17, foregripX: 52, foregripY: 15, muzzleX:  95, muzzleY: 11 },
    { name: 'SNIPER-04',  type: 'sniper',  sx: 354, sy: 612, sw:  93, sh: 22, gripX: 25, gripY: 16, foregripX: 51, foregripY: 13, muzzleX:  92, muzzleY: 10 },
    { name: 'SNIPER-05',  type: 'sniper',  sx: 354, sy: 649, sw: 111, sh: 24, gripX: 28, gripY: 18, foregripX: 58, foregripY: 15, muzzleX: 110, muzzleY: 12 },
    { name: 'SNIPER-06',  type: 'sniper',  sx: 354, sy: 688, sw: 109, sh: 22, gripX: 28, gripY: 17, foregripX: 58, foregripY: 14, muzzleX: 108, muzzleY: 10 },
    { name: 'SNIPER-07',  type: 'sniper',  sx: 354, sy: 725, sw: 118, sh: 18, gripX: 27, gripY: 14, foregripX: 58, foregripY: 12, muzzleX: 117, muzzleY:  5 },
    { name: 'SNIPER-08',  type: 'sniper',  sx: 354, sy: 753, sw: 117, sh: 26, gripX: 27, gripY: 18, foregripX: 57, foregripY: 15, muzzleX: 116, muzzleY: 13 },
    { name: 'SNIPER-09',  type: 'sniper',  sx: 354, sy: 794, sw:  81, sh: 26, gripX: 22, gripY: 17, foregripX: 45, foregripY: 16, muzzleX:  80, muzzleY: 14 },
    { name: 'SNIPER-10',  type: 'sniper',  sx: 354, sy: 835, sw:  81, sh: 21, gripX: 22, gripY: 16, foregripX: 46, foregripY: 14, muzzleX:  80, muzzleY:  9 },

    { name: 'PISTOL-01',  type: 'pistol',  sx: 832, sy: 511, sw:  16, sh: 14, gripX:  5, gripY:  9, foregripX:  7, foregripY:  9, muzzleX: 15, muzzleY:  4 },
    { name: 'PISTOL-02',  type: 'pistol',  sx: 832, sy: 530, sw:  28, sh: 16, gripX:  7, gripY: 10, foregripX: 10, foregripY:  9, muzzleX: 27, muzzleY:  5 },
    { name: 'PISTOL-03',  type: 'pistol',  sx: 832, sy: 551, sw:  26, sh: 16, gripX:  7, gripY: 10, foregripX: 10, foregripY:  9, muzzleX: 25, muzzleY:  4 },
    { name: 'PISTOL-04',  type: 'pistol',  sx: 832, sy: 572, sw:  29, sh: 16, gripX:  7, gripY: 10, foregripX: 11, foregripY:  9, muzzleX: 28, muzzleY:  3 },
    { name: 'PISTOL-05',  type: 'pistol',  sx: 832, sy: 593, sw:  22, sh: 16, gripX:  8, gripY: 11, foregripX: 11, foregripY: 10, muzzleX: 21, muzzleY:  2 },
    { name: 'PISTOL-06',  type: 'pistol',  sx: 832, sy: 614, sw:  29, sh: 16, gripX:  9, gripY: 10, foregripX: 13, foregripY:  9, muzzleX: 28, muzzleY:  2 },
    { name: 'PISTOL-07',  type: 'pistol',  sx: 832, sy: 637, sw:  20, sh: 17, gripX:  8, gripY: 11, foregripX: 11, foregripY: 10, muzzleX: 19, muzzleY:  2 },
    { name: 'PISTOL-08',  type: 'pistol',  sx: 832, sy: 661, sw:  21, sh: 15, gripX:  6, gripY: 10, foregripX:  9, foregripY:  9, muzzleX: 20, muzzleY:  2 }
  ];
