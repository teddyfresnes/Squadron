...
(function () {
  ...
  const MANIFEST = [
    ...
    { name: 'SMG-03',     type: 'smg',     sx:  45, sy:  93, sw:  22, sh: 22, gripX: 15, gripY: 13, foregripX: 18, foregripY: 10, muzzleX: 21, muzzleY:  2 },
    { name: 'SMG-04',     type: 'smg',     sx:  45, sy: 138, sw:  27, sh: 31, gripX: 13, gripY: 19, foregripX: 20, foregripY: 17, muzzleX: 26, muzzleY:  6 },
    { name: 'SMG-05',     type: 'smg',     sx:  45, sy: 183, sw:  46, sh: 13, gripX: 15, gripY: 12, foregripX: 30, foregripY: 12, muzzleX: 45, muzzleY:  7 },
    { name: 'SMG-06',     type: 'smg',     sx:  45, sy: 214, sw:  43, sh: 22, gripX: 18, gripY: 14, foregripX: 30, foregripY: 12, muzzleX: 42, muzzleY: 10 },
    ...
    { name: 'SMG-10',     type: 'smg',     sx:  45, sy: 354, sw:  38, sh: 23, gripX: 14, gripY: 16, foregripX: 24, foregripY: 16, muzzleX: 37, muzzleY:  2 },
    { name: 'SMG-11',     type: 'smg',     sx:  45, sy: 392, sw:  27, sh: 23, gripX: 19, gripY: 14, foregripX: 23, foregripY: 13, muzzleX: 26, muzzleY:  4 },
