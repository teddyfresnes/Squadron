...
(function () {
  ...
  const HOLD_OVERRIDES = {
    'PISTOL-01':  { grip: { x: 21, y: -17 }, rearElbow: { x: 7, y: 0 }, supportElbow: { x: 6, y: 2 }, foregripOffset: { x: 0, y: 1 } },
    'PISTOL-02':  { grip: { x: 23, y: -18 }, rearElbow: { x: 9, y: 0 }, supportElbow: { x: 8, y: 2 }, foregripOffset: { x: 0, y: 1 } },
    'PISTOL-03':  { grip: { x: 22, y: -18 }, rearElbow: { x: 8, y: 0 }, supportElbow: { x: 7, y: 2 }, foregripOffset: { x: 0, y: 1 } },
    'PISTOL-04':  { grip: { x: 23, y: -18 }, rearElbow: { x: 9, y: 0 }, supportElbow: { x: 8, y: 2 }, foregripOffset: { x: 0, y: 1 } },
    'PISTOL-05':  { grip: { x: 22, y: -18 }, rearElbow: { x: 8, y: 0 }, supportElbow: { x: 7, y: 2 }, foregripOffset: { x: 0, y: 1 } },
    'PISTOL-06':  { grip: { x: 23, y: -18 }, rearElbow: { x: 9, y: 0 }, supportElbow: { x: 8, y: 2 }, foregripOffset: { x: 0, y: 1 } },
    'PISTOL-07':  { grip: { x: 22, y: -18 }, rearElbow: { x: 8, y: 0 }, supportElbow: { x: 7, y: 2 }, foregripOffset: { x: 0, y: 1 } },
    'PISTOL-08':  { grip: { x: 21, y: -17 }, rearElbow: { x: 7, y: 0 }, supportElbow: { x: 6, y: 2 }, foregripOffset: { x: 0, y: 1 } },

    'SMG-01':     { grip: { x: 17, y: -12 }, rearElbow: { x: 6, y: 2 }, supportElbow: { x: 10, y: 6 }, foregripOffset: { x: 0, y: 2 } },
    'SMG-02':     { grip: { x: 17, y: -13 }, supportElbow: { x: 10, y: 8 }, foregripOffset: { x: 0, y: 1 } },
    'SMG-03':     { grip: { x: 17, y: -13 }, supportElbow: { x: 8, y: 8 }, foregripOffset: { x: 0, y: 1 } },
    'SMG-04':     { grip: { x: 17, y: -12 }, rearElbow: { x: 6, y: 2 }, supportElbow: { x: 10, y: 7 }, foregripOffset: { x: 0, y: 1 } },
    'SMG-05':     { grip: { x: 19, y: -10 }, supportElbow: { x: 13, y: 4 }, foregripOffset: { x: -4, y: -1 } },
    'SMG-06':     { grip: { x: 18, y: -13 }, supportElbow: { x: 13, y: 8 }, foregripOffset: { x: 0, y: 1 } },
    ...
    'SMG-10':     { grip: { x: 18, y: -12 }, rearElbow: { x: 6, y: 2 }, supportElbow: { x: 10, y: 6 }, foregripOffset: { x: 0, y: 2 } },
    'SMG-11':     { grip: { x: 17, y: -12 }, rearElbow: { x: 6, y: 2 }, supportElbow: { x: 9, y: 6 }, foregripOffset: { x: 0, y: 1 } },
