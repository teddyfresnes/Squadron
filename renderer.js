...
(function () {
  ...
  const HOLD_OVERRIDES = {
    ...
    'HEAVY-07':   { grip: { x: 10, y: -21 }, rearElbow: { x: 5, y: 0 }, supportElbow: { x: 8, y: 5 }, foregripOffset: { x: -7, y: 4 } },
    'HEAVY-08':   { grip: { x: 10, y: -21 }, rearElbow: { x: 5, y: 0 }, supportElbow: { x: 8, y: 5 }, foregripOffset: { x: -7, y: 4 } },
