...
(function () {
  ...
  const HOLD_OVERRIDES = {
    ...
    'SMG-03':     { grip: { x: 17, y: -13 }, supportElbow: { x: 10, y: 7 }, foregripOffset: { x: 0, y: 1 } },
    ...
    'SMG-10':     { grip: { x: 18, y: -12 }, rearElbow: { x: 6, y: 2 }, supportElbow: { x: 10, y: 6 }, foregripOffset: { x: 0, y: 0 } },
    'SMG-11':     { grip: { x: 17, y: -12 }, rearElbow: { x: 6, y: 2 }, supportElbow: { x: 10, y: 7 }, foregripOffset: { x: 0, y: 1 } },
