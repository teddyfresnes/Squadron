...
(function () {
  ...
  const DISPLAY_NAMES_BY_ID = {
    ...
    'SMG-07': 'PN P90 Tac',
    'SMG-08': 'MP5Q-PDW',
    'SMG-09': 'MPX9 Suppressed',
    'SMG-10': 'Thompsen M1A1',
    'SMG-11': 'KRYSS Vector',
    'RIFLE-01': 'AK-48',
    'RIFLE-02': 'AKS-74V',
    'RIFLE-03': 'AK-74N',
    ...
    'SHOTGUN-02': 'Double-Barrel Shogun',
    'SHOTGUN-03': 'Reminton 870',
    'SHOTGUN-04': 'Mossburg 500',
    'SHOTGUN-05': 'Bonelli M4',
    'SHOTGUN-06': 'Blunderbus',
    'SHOTGUN-07': 'Sawed-Off Shogun',
    'SHOTGUN-08': 'Over-Under Shogun',
    'SNIPER-01': 'Accurazy AWP',
    'SNIPER-02': 'AWN Suppressed',
    ...
    'PISTOL-01': 'Walthar PPK',
    'PISTOL-02': 'Kolt Python',
    'PISTOL-03': 'S&W Modal 29',
    'PISTOL-04': 'Ruger Super Redhauk',
    'PISTOL-05': 'Glok 17',
    'PISTOL-06': 'Dezert Eagle',
    'PISTOL-07': 'Gold M1912',
    'PISTOL-08': 'Makarovv PM'
  };

  const ALIASES_BY_ID = {
    'SMG-01': ['Uzi', 'M3 Grease GUN'],
    'SMG-02': ['MAC-10'],
    'SMG-03': ['TEC-9', 'MAC-11'],
    'SMG-04': ['Skorpion vz. 61'],
    'SMG-05': ['HK MP7'],
    'SMG-06': ['FN P90'],
    'SMG-07': ['FN P90 Tactical', 'FN F2000'],
    'SMG-08': ['MP5K-PDW'],
    'SMG-09': ['MP9 Suppressed', 'Colt SCAMP'],
    'SMG-10': ['Thompson M1A1', 'TP9'],
    'SMG-11': ['KRISS Vector', 'MP9'],
    'RIFLE-01': ['AK-47'],
    'RIFLE-02': ['AKS-74U'],
    'RIFLE-03': ['AK-74'],
    ...
    'RIFLE-06': ['HK G3'],
    'RIFLE-07': ['FN FAL'],
    'RIFLE-08': ['FN FAL Tactical', 'M203'],
    'RIFLE-09': ['FAMAS F1'],
    'RIFLE-10': ['FAMAS Compact'],
    'HEAVY-01': ['M202 FLASH', 'INFERNAL TUBE'],
    ...
    'SHOTGUN-02': ['Double-Barrel Shotgun', 'Stoeger Coach Gun'],
    'SHOTGUN-03': ['Remington 870', 'Ithaca 37'],
    'SHOTGUN-04': ['Mossberg 500'],
    'SHOTGUN-05': ['Benelli M4'],
    'SHOTGUN-06': ['Blunderbuss'],
    'SHOTGUN-07': ['Sawed-Off Shotgun', 'Flintlock Shotgun'],
    'SHOTGUN-08': ['Over-Under Shotgun'],
    'SNIPER-01': ['Accuracy International AWP', 'AWP'],
    'SNIPER-02': ['AWM Suppressed', 'AWM'],
    ...
    'PISTOL-01': ['Walther PPK'],
    'PISTOL-02': ['Colt Python', 'Ruger Mark I Silenced'],
    'PISTOL-03': ['S&W Model 29', 'Soviet PB 6P9 Silenced'],
    'PISTOL-04': ['Ruger Super Redhawk', 'High Standard HDM'],
    'PISTOL-05': ['Glock 17', 'Beretta 92'],
    'PISTOL-06': ['Desert Eagle', 'Revolver'],
    'PISTOL-07': ['Gold M1911'],
    'PISTOL-08': ['Makarov PM']
  };
